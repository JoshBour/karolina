 ...
 * Build: http://modernizr.com/download/#-fontface-borderradius-boxshadow-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-draganddrop-input-inputtypes-printshiv-mq-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes
 */
;
window.Modernizr = function (a, b, c) {
    ...
    for (var J in q)A(q, J) && (v = J.toLowerCase(), e[v] = q[J](), t.push((e[v] ? "" : "no-") + v));
